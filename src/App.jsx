...
const MOCK_PRODUCTS = [
  ...
  { id: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', category_id: 'cat_dairy', name: 'Cow Milk', price: 65, unit: '1L', image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: false },
  { id: 'b2c3d4e5-f6a7-8901-bcde-f12345678901', category_id: 'cat_dairy', name: 'Buffalo Milk', price: 70, unit: '1L', image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: false },
  { id: 'c3d4e5f6-a7b8-9012-cdef-123456789012', category_id: 'cat_dairy', name: 'Curd made from Cow Milk', price: 45, unit: '500g', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: true },
  { id: 'd4e5f6a7-b8c9-0123-def0-234567890123', category_id: 'cat_dairy', name: 'Curd made from Buffalo Milk', price: 50, unit: '500g', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: true },
  { id: 'e5f6a7b8-c9d0-1234-ef01-345678901234', category_id: 'cat_dairy', name: 'Organic Ghee', price: 450, unit: '500ml', image: 'https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: true },
  { id: 'f6a7b8c9-d0e1-2345-f012-456789012345', category_id: 'cat_dairy', name: 'Fresh Cream made from Cow Milk', price: 80, unit: '200ml', image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: true },
  { id: 'a7b8c9d0-e1f2-3456-0123-567890123456', category_id: 'cat_dairy', name: 'Paneer', price: 90, unit: '200g', image: 'https://images.unsplash.com/photo-1595295333158-4742f28fbd85?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: true, instantOrder: false, inStock: true, earlyMorningDelivery: true },
  
  // Bakery - Most items instant + subscription, Croissant instant only
  { id: 'b8c9d0e1-f2a3-4567-1234-678901234567', category_id: 'cat_bakery', name: 'Whole Wheat Unsliced Bread', price: 45, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'c9d0e1f2-a3b4-5678-2345-789012345678', category_id: 'cat_bakery', name: 'Whole Wheat Sliced Bread', price: 48, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'd0e1f2a3-b4c5-6789-3456-890123456789', category_id: 'cat_bakery', name: 'Sliced Milk Bread', price: 40, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'e1f2a3b4-c5d6-7890-4567-901234567890', category_id: 'cat_bakery', name: 'Unsliced Milk Bread', price: 38, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'f2a3b4c5-d6e7-8901-5678-012345678901', category_id: 'cat_bakery', name: 'White Sandwich Bread', price: 42, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'a3b4c5d6-e7f8-9012-6789-123456789012', category_id: 'cat_bakery', name: 'Brown Sandwich Bread', price: 48, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'b4c5d6e7-f8a9-0123-7890-234567890123', category_id: 'cat_bakery', name: 'Multigrain Bread', price: 55, unit: '400g', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'c5d6e7f8-a9b0-1234-8901-345678901234', category_id: 'cat_bakery', name: 'Kulcha Bread', price: 35, unit: '4 pcs', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'd6e7f8a9-b0c1-2345-9012-456789012345', category_id: 'cat_bakery', name: 'Bun Bread', price: 30, unit: '4 pcs', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'e7f8a9b0-c1d2-3456-0123-567890123456', category_id: 'cat_bakery', name: 'Pav Bread', price: 32, unit: '8 pcs', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'f8a9b0c1-d2e3-4567-1234-678901234567', category_id: 'cat_bakery', name: 'Croissant', price: 60, unit: '1 pc', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=300&q=80', subscribable: false, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  
  // Organic Essentials - Instant order only
  { id: 'a9b0c1d2-e3f4-5678-2345-789012345678', category_id: 'cat_honey', name: 'Organic Honey', price: 350, unit: '500g', image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d30?auto=format&fit=crop&w=300&q=80', subscribable: false, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'b0c1d2e3-f4a5-6789-3456-890123456789', category_id: 'cat_honey', name: 'Organic Jaggery', price: 180, unit: '500g', image: 'https://images.unsplash.com/photo-1587049352846-4a222e784d30?auto=format&fit=crop&w=300&q=80', subscribable: false, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  
  // Fresh Flowers - Both subscription + instant order
  { id: 'c1d2e3f4-a5b6-7890-4567-901234567890', category_id: 'cat_flowers', name: 'Marigold', price: 50, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1574167227613-81927d583814?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'd2e3f4a5-b6c7-8901-5678-012345678901', category_id: 'cat_flowers', name: 'Lotus', price: 80, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1518568814500-bf0f8d125f46?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'e3f4a5b6-c7d8-9012-6789-123456789012', category_id: 'cat_flowers', name: 'Kathanda', price: 45, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'f4a5b6c7-d8e9-0123-7890-234567890123', category_id: 'cat_flowers', name: 'Chameli', price: 55, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1599839575945-a9e5af0c3fa5?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'a5b6c7d8-e9f0-1234-8901-345678901234', category_id: 'cat_flowers', name: 'Aparajita (Blue)', price: 60, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1518882605630-8a58d8f09e4d?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'b6c7d8e9-f0a1-2345-9012-456789012345', category_id: 'cat_flowers', name: 'Aparajita (White)', price: 60, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1468327768560-75b778cbb551?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'c7d8e9f0-a1b2-3456-0123-567890123456', category_id: 'cat_flowers', name: 'Dhruva', price: 40, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'd8e9f0a1-b2c3-4567-1234-678901234567', category_id: 'cat_flowers', name: 'Tulsi', price: 35, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1628022777348-3a0d1c93b283?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'e9f0a1b2-c3d4-5678-2345-789012345678', category_id: 'cat_flowers', name: 'Aak', price: 45, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'f0a1b2c3-d4e5-6789-3456-890123456789', category_id: 'cat_flowers', name: 'Kaner/Karabi', price: 50, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'a1b2c3d4-e5f6-7890-4567-901234567890', category_id: 'cat_flowers', name: 'Nayantara', price: 40, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1568737346870-284011925606?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'b2c3d4e5-f6a7-8901-5678-012345678901', category_id: 'cat_flowers', name: 'Red Hibiscus', price: 45, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1518882605630-8a58d8f09e4d?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'c3d4e5f6-a7b8-9012-6789-123456789012', category_id: 'cat_flowers', name: 'Dhatura Flower', price: 55, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'd4e5f6a7-b8c9-0123-7890-234567890123', category_id: 'cat_flowers', name: 'Rajnigandha', price: 70, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1599839575945-a9e5af0c3fa5?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'e5f6a7b8-c9d0-1234-8901-345678901234', category_id: 'cat_flowers', name: 'Barmala', price: 60, unit: '1 Bunch', image: 'https://images.unsplash.com/photo-1574167227613-81927d583814?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'f6a7b8c9-d0e1-2345-9012-456789012345', category_id: 'cat_flowers', name: 'Bel Leaves (108 leaves)', price: 80, unit: '108 Leaves', image: 'https://images.unsplash.com/photo-1628022777348-3a0d1c93b283?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
  { id: 'a7b8c9d0-e1f2-3456-0123-567890123456', category_id: 'cat_flowers', name: 'Betel Leaves', price: 25, unit: '10 Leaves', image: 'https://images.unsplash.com/photo-1628022777348-3a0d1c93b283?auto=format&fit=crop&w=300&q=80', subscribable: true, preOrder: false, instantOrder: true, inStock: true, earlyMorningDelivery: false },
];
